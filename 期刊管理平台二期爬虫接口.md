...
|参数|是否必选|类型|描述
|-|-|-|-
|seriesId|是	|string	|爬虫对应的期刊id，唯一索引/出错期刊
|scouterName|是	|string	|爬虫名称，唯一索引
|lastRuncode|是	|int	|结果代码，0正常，>0为出错代码
|lastRunmessage|是	|string	|检查结果的消息，空为正常，非空为给管理员的提示
|updateSeries|是	|arry	|本次更新了哪些刊
|+seriesId|是	|string	|刊标识
|+lastYear|是	|string	|以年月形式的刊的最新信息
|+lastMonth|是	|string	|以年月形式的刊的最新信息
|+lastVol|是	|string	|以卷期形式的刊的最新信息
|+lastIssue|是	|string	|以卷期形式的刊的最新信息
|+lastCrawlamount|是	|string	|本刊文献更新量
|+lastpublishTime|是	|string	|如果能得到最新数据的出版时间
