...
|nextYear|是	|string	|以年月形式的刊的最新信息
|nextMonth|是	|string	|以年月形式的刊的最新信息
|nextVol|是	|string	|以卷期形式的刊的最新信息
|nextIssue|是	|string	|以卷期形式的刊的最新信息
|endIssue|是	|string	|如果不能拆成年月或卷期，以原始格式给管理员提示
